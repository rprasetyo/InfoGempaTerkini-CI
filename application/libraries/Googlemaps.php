...
class Googlemaps {
    ...
    var $apiKey						= 'AIzaSyDjqKXn86Fg2Iwc8vSU6LAKKSGaq6L83Ic'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
